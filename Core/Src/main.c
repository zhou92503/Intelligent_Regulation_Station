...
int main(void)
{
  ...
  dht11_TaskHandle = osThreadNew(Start_dht_Task, NULL, &dht11_Task_attributes);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_0|DHT11_Pin_Pin|GPIO_PIN_6|GPIO_PIN_7, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PB0 DHT11_Pin_Pin PB6 PB7 */
  GPIO_InitStruct.Pin = GPIO_PIN_0|DHT11_Pin_Pin|GPIO_PIN_6|GPIO_PIN_7;
...
__weak void Start_OLED_Task(void *argument)
{
  /* USER CODE BEGIN 5 */
  /* Infinite loop */
  for(;;)
...
/**
* @brief Function implementing the air_sensor_Task thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_Start_air_sensor_Task */
__weak void Start_air_sensor_Task(void *argument)
{
  /* USER CODE BEGIN Start_air_sensor_Task */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END Start_air_sensor_Task */
}

/* USER CODE BEGIN Header_Start_dht_Task */
/**
* @brief Function implementing the dht11_Task thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_Start_dht_Task */
__weak void Start_dht_Task(void *argument)
{
  /* USER CODE BEGIN Start_dht_Task */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END Start_dht_Task */
}
...
__weak void Start_key_Task(void *argument)
{
...
__weak void Start_encoder_Task(void *argument)
{
...
__weak void Start_Battery_Task(void *argument)
{
